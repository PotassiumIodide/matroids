...
@pytest.mark.parametrize('spanning_matroid, expected', [
    ...
    (( {1,2,3}, [{1},{1,2},{1,3},{1,2,3}] )                    , lambda X: len(X) - 1 if 1 in X else len(X)   ),
    (( {1,2,3}, [{1},{2},{1,2},{1,3},{2,3},{1,2,3}] )          , lambda X: len(X) if X <= {3} else len(X) - 1 ),
    (( {1,2,3}, [{1},{2},{3},{1,2},{1,3},{2,3},{1,2,3}] )      , lambda X: len(X) - 1 if X else len(X)        ),
    (( {1,2,3}, [{1,2},{1,2,3}] )                              , lambda X: 1 if 3 in X else 0                 ),
    (( {1,2,3}, [{1,2},{1,3},{1,2,3}] )                        , lambda X: 1 if {2,3} <= X else 0             ),
    (( {1,2,3}, [{1,2},{1,3},{2,3},{1,2,3}] )                  , lambda X: len(X) - 2 if X == {1,2,3} else 0  ),
    (( {1,2,3}, [{1,2,3}] )                                    , lambda X: 0                                  ),
])
